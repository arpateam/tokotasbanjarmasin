    ...
    <div class="panel-header bg-primary-gradient pb-5">
        <div class="page-inner py-5">
            <div class="text-center">
                <h1 class="text-white pb-2 fw-bold"><i class="fas fa-check"></i> Pesanan Selesai</h1>
            </div>
        </div>
    </div>
...
<div class="content">
    <div class="panel-header bg-primary-gradient pb-5">
        <div class="page-inner py-5">
            <div class="text-center">
                <h5>
                    <a href="pesanan-selesai" class="text-light" style="text-decoration: none;"><i class="fas fa-arrow-left"></i> Kembali ke Daftar <strong>Transaksi Pesanan Selesai</strong></a>
                </h5>
                                                    ...
                                                    <div class="card-header">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 fw-bold text-end-3 pb-3">
                                                                ...
                                                                <h4 class="fw-bold mt-3">
                                                                    <h4 class="mb-2 fw-bold text-success">Selesai pada: </h4>
