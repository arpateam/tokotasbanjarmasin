    ...
    <div class="panel-header bg-primary-gradient pb-5">
        <div class="page-inner py-5">
            <div class="text-center">
                <h1 class="text-white pb-2 fw-bold"><i class="fas fa-shipping-fast"></i> Sedang Dikirim</h1>
            </div>
        </div>
    </div>
...
<div class="content">
    <div class="panel-header bg-primary-gradient pb-5">
        <div class="page-inner py-5">
            <div class="text-center">
                <h5>
                    <a href="sedang-dikirim" class="text-light" style="text-decoration: none;"><i class="fas fa-arrow-left"></i> Kembali ke Daftar <strong>Transaksi Sedang Dikirim</strong></a>
                </h5>
                ...
                <div class="card">
                    ...
                    <div class="card-body tab-content pb-0" id="pills-without-border-tabContent">
                                                    ...
                                                    <div class="card-header">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 fw-bold text-end-3 pb-3">
                                                                <h4 class="fw-bold">
                                                                    <h4 class="mb-2 fw-bold text-success">Waktu transaksi: </h4>
                                                                ...
                                                                <h4 class="fw-bold mt-3">
                                                                    <h4 class="mb-2 fw-bold text-success">Dikirim pada: </h4>
                                                                    <i class="far fa-calendar-check"></i> <?= tgl2($resultData['date_pengiriman']) ?>
                                                                    <br />
                                                                    <i class="far fa-clock"></i> <?= $resultData['time_pengiriman'] ?> WIB
                                                                </h4>
                        ...
                        <div class="col-12 my-4">
                            <a onclick="confirmSelesaikanPesanan('<?= $resultData['session']; ?>')" class="btn btn-block btn-lg btn-success"><h2 class="fw-bold mb-0"><i class="fas fa-check"></i> SELESAIKAN PESANAN</h2></a>
                        </div>
                    </div>
                </div>
            </div>
