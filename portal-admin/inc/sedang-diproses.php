                        ...
                        <div class="table-responsive">
                            <table id="tabelData" class="table table-striped table-bordered py-2" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        $Data = $pdo->query("SELECT kode_invoice, session, nama_penerima, nomor_whatsapp, total_pembayaran FROM invoice WHERE status='Diproses' ORDER BY date_transaksi ASC");
