    ...
    <div class="panel-header bg-primary-gradient pb-5">
        <div class="page-inner py-5">
            <div class="text-center">
                <h1 class="text-white pb-2 fw-bold"><i class="fas fa-newspaper"></i> PROMO</h1>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="text-secondary fw-bold">Daftar Promo</h2>
                            </div>
                            <div class="ml-md-auto py-2 py-md-0">
                                <a href="tambah-promo" class="btn btn-secondary"><i class="fas fa-plus"></i> Tambah Promo</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="tabelData" class="table table-striped table-bordered py-2" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" width="300px">Judul Promo</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="ubah-promo-<?= $resultData['id_promo']; ?>">
                                                <button type="button" class="btn btn-sm btn-primary">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                            </a>
                                            <a onclick="confirmHapusPromo('<?= $resultData['id_promo']; ?>')" class="btn btn-sm btn-danger text-light"><i class="fas fa-trash-alt"></i></a>
                                        </td>
                                        <td><?= $resultData['judul']; ?></td>
                                        <td><img src="../assets/images/promo/small/<?= $resultData['gambar']; ?>" alt="<?= $resultData['gambar']; ?>" class="img-thumbnail my-2"></td>
...
<div class="content">
    <div class="panel-header bg-primary-gradient pb-5">
        <div class="page-inner py-5">
            <div class="text-center">
                <h5>
                    <a href="promo" class="text-light" style="text-decoration: none;"><i class="fas fa-arrow-left"></i> Kembali ke Daftar Promo</a>
                </h5>
                <h1 class="text-white pb-2 fw-bold"><i class="fas fa-newspaper"></i> TAMBAH PROMO</h1>
            </div>
        </div>
    </div>
    <div class="page-inner mt--5">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body tab-content pb-0" id="pills-without-border-tabContent">
                        <form method="POST" action="actionTambahPromo" enctype="multipart/form-data" class="text-left needs-validation" novalidate>
                            <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group-default">
                                            ...
                                            <div class="invalid-feedback fw-bold">
                                                <i class="fas fa-exclamation-triangle"></i> Mohon Masukkan Judul Promo!
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <!-- Gambar Promo -->
                                    <div class="col-12 mt-4">
                                        <div class="alert alert-primary shadow-sm pb-2" role="alert">
                                            <h4 class="fw-bold text-primary"><i class="fas fa-image"></i> Gambar Promo</h4>
                                        </div>
                                    </div>
                                ...
                                <!-- Deskripsi Promo -->
                                    <div class="col-12 mt-4 mb-2">
                                        <div class="alert alert-primary shadow-sm pb-2" role="alert">
                                            <h4 class="fw-bold text-primary"><i class="fas fa-newspaper"></i> Deskripsi Promo</h4>
                                        </div>
                                    </div>
...
<?php
        ...
        $Data       = $pdo->query("SELECT id_promo, judul, gambar, deskripsi, keyword, description, id_sitemap_1  FROM promo WHERE id_promo='$_GET[kode]'");
        $resultData = $Data->fetch(PDO::FETCH_ASSOC);
        $jmlData    = $Data->rowCount(PDO::FETCH_ASSOC);

        if ($jmlData===0) {
            echo "<script>window.location = 'promo';</script>";
            die();
            exit();
        }
?>
    ...
    <div class="panel-header bg-primary-gradient pb-5">
        <div class="page-inner py-5">
            <div class="text-center">
                ...
                <h1 class="text-white pb-2 fw-bold"><i class="fas fa-newspaper"></i> Mengubah Promo <hr /><u>"<?= $resultData['judul'] ?>"</u></h1>
            </div>
        </div>
    </div>
    <div class="page-inner mt--5">
        <div class="row justify-content-center mt--5">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body tab-content pb-0" id="pills-without-border-tabContent">
                        <form method="POST" action="actionEditPromo" enctype="multipart/form-data" class="text-left needs-validation" novalidate>
                            <div class="row">
                                ...
                                <!-- Gambar Promo -->
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="file-upload-content-edit text-center">
                                            ...
                                            <img class="file-upload-image px-2 pt-2 px-md-4" src="../assets/images/promo/<?= $resultData['gambar']; ?>" alt="<?= $resultData['judul']; ?>" />
                                        ...
                                        <div class="invalid-feedback fw-bold">
                                            Mohon pilih gambar untuk Promo anda
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 my-4">
                                    <input type="hidden" name="___in_id_promo_special_SEMANAK" value="<?= $resultData['id_promo']; ?>">
